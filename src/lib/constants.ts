 ...
 */
export const APP_NAME: string = 'Bouncing Balls';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'An arcade football game with bouncing balls';
 ...
 */
export const APP_TAGS: string[] = ['football', 'arcade', 'bouncing', 'balls'];
